...
@section('css')
<link href="{{ asset('css/pages/news_post.css') }}" rel="stylesheet">
@endsection
...
<div class="contaier news_post pt-4 m-5">
  <div class="row">
...
<script src="{{ asset('js/pages/news_post.js') }}" charset="utf-8" defer></script>
@endsection
