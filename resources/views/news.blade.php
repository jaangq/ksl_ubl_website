...
@section('content')
<div class="contaier news pt-4">
  <nav class="nav-news pt-2">
    <ul class="d-inline-block">
      <li class="active"><a href="#">Most Recent</a></li>
      <li><a href="#">Popular</a></li>
      <li><a href="#">Most Viewed</a></li>
    </ul>
    <div class="search-news d-inline-block position-relative">
      <input class="form-control d-inline-block" type="text" name="" placeholder="Search News"><button class="btn btn-primary" type="button" name="button"><i class="fas fa-search"></i></button>
    </div>
  </nav>
...
<script src="{{ asset('js/pages/news.js') }}" charset="utf-8" defer></script>
@endsection
